...
setErrorMessage('Login failed. Please check your email and password.');      
  ...
  return (
    <MainBox>
     <AutoBox>
     <LoginBox>
     <Typography variant='h3' fontWeight={600} style={{fontFamily:"Kanit, sans-serif",}}>Login</Typography>
     <IconBox>
...
Forgot Password?
     ...
     <RightBox>
      <Typography variant='h4' fontWeight={600} style={{fontFamily:"Kanit, sans-serif", fontWeight:"600" }}>Why Connect us.</Typography>
      <img src={LoginImg} alt="imt" style={{width:"200px"}} />    
      <Box>
      <Typography variant='subtitle1' style={{ textAlign:"center" ,color:"#dedcdc", fontSize:"14px", fontFamily:"Kanit, sans-serif",}}>
